...
class runbot_build(models.Model):
    ...
    gc_date = fields.Datetime('Local cleanup date', compute='_compute_gc_date', store=True)
    ...
    def _compute_gc_date(self):
        ...
        for build in self:
            ref_date = fields.Datetime.from_string(self.job_end or self.create_date or fields.Datetime.now())
            max_days = max_days_main if not self.parent_id else max_days_child
